...
# 2. initialization:
#    we use weight.data.normal_(mean=0, std=0.01)
#    tensorflow version: truncated normal(mean=0, std=0.01) within 2 std
...
class S3D(nn.Module):
    ...
    def __init__(self, first_channel=3, gating=False):
